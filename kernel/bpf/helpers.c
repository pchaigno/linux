			     ...
			     u32 offset, u64 flags)
{
	...
	default:
		BPF_WARN_ONCE(true, "bpf_dynptr_read: unknown dynptr type %d\n", type);
		return -EFAULT;
	}
}
		       ...
		       u32 len, u64 flags)
{
	...
	default:
		BPF_WARN_ONCE(true, "bpf_dynptr_write: unknown dynptr type %d\n", type);
		return -EFAULT;
	}
}
...
BPF_CALL_3(bpf_dynptr_data, const struct bpf_dynptr_kern *, ptr, u32, offset, u32, len)
{
	...
	case BPF_DYNPTR_TYPE_XDP:
		...
		return 0;
	default:
		BPF_WARN_ONCE(true, "bpf_dynptr_data: unknown dynptr type %d\n", type);
		return 0;
	}
}
				   ...
				   void *buffer__opt, u32 buffer__szk)
{
	...
	default:
		BPF_WARN_ONCE(true, "unknown dynptr type %d\n", type);
		return NULL;
	}
}
